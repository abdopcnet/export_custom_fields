// Frontend logging: console.log('[custom_field_list.js] method: function_name')
				...
				.add_button(
					...
					function () {
						...
						frappe.call({
							...
							args: {
								custom_field_names: selected_names,
							},
							freeze: true,
...
console.log('[custom_field_list.js] method: listview_settings');
