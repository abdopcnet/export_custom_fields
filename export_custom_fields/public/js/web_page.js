...
// Frontend logging: console.log('[web_page.js] method: function_name')
		...
		if (frappe.boot.developer_mode) {
			...
			if (frm.doc.module) {
				frm.add_custom_button(__('Export to Module'), function () {
					...
					frappe.call({
						method: 'export_custom_fields.web_page.export_web_pages_by_module',
						args: {
						...
						callback: function (r) {
							if (!r.exc) {
								frappe.show_alert({
									message: __('Web Pages exported successfully'),
									indicator: 'green',
								});
							}
						},
...
console.log('[web_page.js] method: form_settings');
